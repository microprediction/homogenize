...
plt.plot(ts,[approximator.v2_symmetric_approx(t) for t in ts])

plt.legend(['Symmetric 1st order','Antisymmetric 1st order','Symmetric 2nd order','Antisymmetric 2nd order','Symmetric 2nd order (approx)'])
plt.xlabel('Time')
